...
extern void vlog(log_level_t level, const char* fmt, ...);
...
#define NOTICE(fmt,...)                                                 \
    (common::vlog(common::T_NOTICE,                                     \
                  "[%s][%s:%d]"fmt,                                     \
                  __FUNCTION__, __FILE__, __LINE__, ##__VA_ARGS__))
#define TRACE(fmt,...)                                              \
    (common::vlog(common::T_TRACE,                                  \
                  "[%s][%s:%d]"fmt,                                 \
                  __FUNCTION__, __FILE__, __LINE__, ##__VA_ARGS__))
#define WARNING(fmt,...)                                            \
    (common::vlog(common::T_WARNING,                                \
                  "[%s][%s:%d]"fmt,                                 \
                  __FUNCTION__, __FILE__, __LINE__, ##__VA_ARGS__))
#define FATAL(fmt,...)                                                  \
    (common::vlog(common::T_FATAL,                                      \
                  "[%s][%s:%d]"fmt,                                     \
                  __FUNCTION__, __FILE__, __LINE__, ##__VA_ARGS__))
